...
const { postCreateCustomerAPI, postCreateArrayCustomerAPI, getCustomersAPI, patchUpdateCustomerAPI, deleteCustomerAPI } = require('../controllers/customerController')
