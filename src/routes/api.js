...
const { postCreateCustomerAPI, postCreateArrayCustomerAPI, getCustomersAPI, patchUpdateCustomerAPI, deleteCustomerAPI, deleteArrayCustomerAPI } = require('../controllers/customerController')
